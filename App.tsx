        ...
        return (
            <div key={sessionKey} className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
                <div className="w-full max-w-xl">
                    {/* Medical Login + User Manual Buttons */}
                    <div className="flex items-center justify-between mb-4">
                        <a
                            href="/Duo_User_Manual.pdf"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 text-sm text-sky-600 font-bold bg-sky-50 px-3 py-1.5 rounded-lg hover:bg-sky-100"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 text-sm text-teal-600 font-bold bg-teal-50 px-3 py-1.5 rounded-lg hover:bg-teal-100"
                        >
                    ...
                    <div className="mb-6 flex items-center gap-5">
                        <img src="/logo-chat.png" alt="Duo logo" className="w-28 h-28" />
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900">Duo</h1>
                            <p className="text-slate-500 text-sm md:text-base mt-1">
                                CRPS 환자와 의료진의 의사결정을 돕는 서비스
                            </p>
                        </div>
                    </div>
